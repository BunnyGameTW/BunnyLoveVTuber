...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("對話紀錄") action ShowMenu('history')
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu and persistent.showGallery:
            textbutton _("畫廊") action ShowMenu("gallery")
...
screen about():
    ...
    use game_menu(_("關於"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("這只是一個企劃提案的demo，如有巧合純屬虛構")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("返回上一步")
                    textbutton _("禁止") action Preference("rollback side", "disable")
                ...
                vbox:
                    style_prefix "check"
                    label _("略過")
                    textbutton _("未看過的文字") action Preference("skip", "toggle")
